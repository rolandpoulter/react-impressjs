  ...
  _createClass(Impress, [{
    ...
    value: function componentDidMount() {
      ...
      this.onResize = (0, _util.throttle)(function () {
        if (impressSupported) {
          _this2.goto(_this2.state.activeStep, 500, true);
        }
      }, 250);
      ...
      this.onHashChange = (0, _util.throttle)(function () {
        if (window.location.hash !== _lastHash) _this2.gotoElementFromHash();
      }, 250);
      window.addEventListener('hashchange', this.onHashChange, false);
    }
  }, {
    key: 'gotoElementFromHash',
    value: function gotoElementFromHash() {
      return this.goto((0, _util.getElementFromHash)(_stepsData), 500);
    }
  }, {
    key: 'getElementFromHash',
    value: function getElementFromHash(object) {
      return (0, _util.getElementFromHash)(object);
    }
  }, {
    key: 'getStepData',
    ...
    value: function goto(step) {
      ...
      var skipCallbacks = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      ...
      !skipCallbacks && this.props.onGoTo && this.props.onGoTo.call(this, this, step, duration);
    ...
    key: 'prev',
    value: function prev() {
      var progressDivision = this.props.progressDivision;
      ...
      prev = prev >= 0 ? stepsDataKeys[prev] : stepsDataKeys[stepsDataKeys.length - progressDivision];
    ...
    value: function end() {
      ...
      var stepsDataEntries = Object.entries(_stepsData);
      var lastStep = stepsDataEntries[stepsDataEntries.length - progressDivision][1];
    ...
    value: function stepComponent(step, index) {
      ...
      return _react2.default.cloneElement(step, {
        ...
        goto: this.props.disableEvents ? null : this.props.onPickStep ? this.props.onPickStep.bind(this, this.goto.bind(this)) : this.goto.bind(this)
      }, step.props.children);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var _props = this.props,
          ...
          progressGroups = _props.progressGroups,
          skipSteps = _props.skipSteps;
...
Impress.propTypes = {
  ...
  onBeforeGoTo: _propTypes2.default.func,
  onPickStep: _propTypes2.default.func,
  disableEvents: _propTypes2.default.bool,
  progressDivision: _propTypes2.default.number,
  progressGroups: _propTypes2.default.array,
  skipSteps: _propTypes2.default.number
};
