...
var Step = function (_Component) {
  ...
  _createClass(Step, [{
    ...
    value: function getStyle() {
      ...
      var _stepStyle = _extends({}, this.props.style || {}, {
        position: 'absolute',
    ...
    value: function render() {
      var _props2 = this.props,
          activeStep = _props2.activeStep,
          children = _props2.children;
      var _state3 = this.state,
          id = _state3.id,
          isPresented = _state3.isPresented;
      ...
      return _react2.default.createElement(
        ...
        typeof children === 'function' ? children(activeStep.id === id, isPresented) : children
      );
    }
  }]);
