...
var Progress = function (_Component) {
  ...
  _createClass(Progress, [{
    ...
    value: function render() {
      ...
      // TODO: progressGroups
      var group = progressGroups.length ? 0 : null;
      if (progressGroups.length) {
        // debugger;
        var i = currentStepIndex;
        progressGroups.some(function (g, index) {
          if (g < i) {
            i -= g;
            group = index;
            return true;
      ...
      var step = Math.floor((currentStepIndex + skipSteps) / skipSteps);
      var final = Math.floor((stepsTotal + skipSteps) / skipSteps);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          { className: 'ratio', style: { color: color_gray, width: percent + '%' } },
          _react2.default.createElement(
            'span',
            null,
            step,
